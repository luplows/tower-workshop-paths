...
The remaining unknown is whether the stored secret is exactly the token (a truncated paste gives the same 401) or whether this is [action#1614](https://github.com/anthropics/claude-code-action/issues/1614), which is open with no workaround.
