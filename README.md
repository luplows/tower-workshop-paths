...
- A phone-mimicking React UI, switchable via a top "Upgrade" / "Enhance" / "Path" mode tab bar (matching the in-game buttons where applicable) between three screens:
  ...
  - **Path**: a ranked list of every not-yet-maxed Workshop upgrade, cheapest next level first — a placeholder for the full priority-weighted buy-order recommendation, see below.
  - Upgrade and Enhance share the same three-tree tab layout, labeled just Attack / Defense / Utility.
