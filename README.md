...
Not built yet: the full priority-weighted buy-order algorithm (the tool's core feature — the Path screen above is a cost-only first cut), discount-lab handling, and Workshop upgrade-unlock gating. See [Open-Questions.md](Open-Questions.md) for details on each.
